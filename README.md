...
| | |
|---|---|
| Live demo | [ai-blockchain-mood-journal.onrender.com](https://ai-blockchain-mood-journal.onrender.com) *(hosted on Render's free tier — may take 20–30s to wake up)* |
| Built for | BlockDAG Hackathon 2025 |
| Author | Gagandeep — built solo, end-to-end |
| License | MIT |
